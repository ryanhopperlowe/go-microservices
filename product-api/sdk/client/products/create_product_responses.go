...
func (o *CreateProductReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		result := NewCreateProductNoContent()
...
// NewCreateProductNoContent creates a CreateProductNoContent with default headers values
func NewCreateProductNoContent() *CreateProductNoContent {
	return &CreateProductNoContent{}
}

/*
CreateProductNoContent describes a response with status code 204, with default header values.

CreateProductNoContent create product no content
*/
type CreateProductNoContent struct {
}

// IsSuccess returns true when this create product no content response has a 2xx status code
func (o *CreateProductNoContent) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this create product no content response has a 3xx status code
func (o *CreateProductNoContent) IsRedirect() bool {
	return false
}

// IsClientError returns true when this create product no content response has a 4xx status code
func (o *CreateProductNoContent) IsClientError() bool {
	return false
}

// IsServerError returns true when this create product no content response has a 5xx status code
func (o *CreateProductNoContent) IsServerError() bool {
	return false
}

// IsCode returns true when this create product no content response a status code equal to that given
func (o *CreateProductNoContent) IsCode(code int) bool {
	return code == 204
}

// Code gets the status code for the create product no content response
func (o *CreateProductNoContent) Code() int {
	return 204
}

func (o *CreateProductNoContent) Error() string {
	return fmt.Sprintf("[POST /products][%d] createProductNoContent ", 204)
}

func (o *CreateProductNoContent) String() string {
	return fmt.Sprintf("[POST /products][%d] createProductNoContent ", 204)
}

func (o *CreateProductNoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
