...
type ClientService interface {
	CreateProduct(params *CreateProductParams, opts ...ClientOption) (*CreateProductNoContent, error)
...
*/
func (a *Client) CreateProduct(params *CreateProductParams, opts ...ClientOption) (*CreateProductNoContent, error) {
	...
	success, ok := result.(*CreateProductNoContent)
	if ok {
		return success, nil
	}
